...
const Coin = __webpack_require__(1);
...
class Game {
  constructor(){
    ...
    this.coins = [];
    this.coinCount = 0;
    // setInterval(this.addEnemy.bind(this), 200)
    setTimeout(this.addEnemies.bind(this), 2500);
    setInterval(this.addCoin.bind(this), 1000);
  }

  addEnemies(){
    setInterval(this.addEnemy.bind(this), 300); // controls the amount of enemies//200
  }
  ...
  collideWith(otherObject) {
    if (otherObject instanceof Enemy) {
      ...
      return true;
        ...
        console.log(this.game.coinCount)
        return true;
    }
  }
